...
else: # TODO: modify the arguments below depending on your setup
    judge_args = ['cat.exe'] # ['cat.exe']
    sol_args = ['Assignment2.exe'] # ['assignment2.exe']

print(judge_args, sol_args)
